...
class DeployNode():
    ...
    def __init__(self):
        ...
        self.motion_config = OmegaConf.load("/home/dreams/Users/yixiaofeng/Humanoid_robot_deployment/sim2sim/configs/g1_ref_real_kungfu.yaml")
        # init policy
        self.init_policy()
        self.initing_action_policy()
