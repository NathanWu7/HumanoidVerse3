...
from HumanoidVerse3.motion_lib.motion_lib_robot import MotionLibRobot
...
class DeployNode():
    ...
    def __init__(self):
        ...
        self.motion_config = OmegaConf.load("/home/yang/robot_deploy/Humanoid_robot_deployment/sim2sim/configs/g1_ref_real.yaml")
        # init policy
        self.init_policy()
